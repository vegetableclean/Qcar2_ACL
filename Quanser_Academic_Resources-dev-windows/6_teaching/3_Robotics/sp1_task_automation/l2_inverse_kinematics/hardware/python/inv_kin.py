...
time.sleep(3)
print('driver loaded')
ipHost, ipDriver = '192.168.2.22', 'localhost'
...
try:
    ...
    while noKill and not endFlag:
        ...
        if probe.connected:
            ...
            newGPad = gpad.read()
            arm = gpad.buttonLeft
            forSpdCmd = 0.7*gpad.rightJoystickY/2
            turnSpdCmd = 3.564*gpad.leftJoystickX/2
            ...
            if newHIL:
                ...
                # Section F - Sending data to Observer in main computer
